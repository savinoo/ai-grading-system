...
Embora o uso de IA em avaliação educacional tenha avançado, ainda se observa uma lacuna entre resultados experimentais e aplicação institucional contínua. Parte relevante das abordagens existentes prioriza métricas de desempenho preditivo em cenários controlados, com menor ênfase na integração ao fluxo real de correção docente, na explicitação dos critérios pedagógicos utilizados e na rastreabilidade das decisões automatizadas \cite{borges_avaliacao_2017, shahzad_comprehensive_2025}. Como consequência, permanecem desafios relacionados à viabilidade prática de adoção, à auditabilidade do processo e à consistência preliminar entre correções.

\section{Objetivos}

\subsection{Objetivo Geral} 
Desenvolver um sistema de apoio à decisão docente na correção de provas discursivas utilizando modelos avançados de linguagem (LLMs), apoiado pela recuperação dinâmica de contexto, de modo a produzir avaliações preliminares consistentes e alinhadas aos critérios pedagógicos estabelecidos pelos professores, mantendo a revisão, o ajuste e a decisão final sob responsabilidade do docente.
...
\item Persistir resultados detalhados por critério em estrutura que viabilize a geração de indicadores analíticos e relatórios de desempenho, com exportação dos dados experimentais em formatos reutilizáveis (JSON e \LaTeX), de modo a apoiar a análise dos resultados e a adaptação do planejamento de aulas.
