...
Embora o uso de \gls{ia} em avaliação educacional tenha avançado, ainda se observa uma lacuna entre resultados experimentais e aplicação institucional contínua. Parte relevante das abordagens existentes prioriza métricas de desempenho preditivo em cenários controlados, com menor ênfase na integração ao fluxo real de correção docente, na explicitação dos critérios pedagógicos utilizados e na rastreabilidade das decisões automatizadas \cite{borges_avaliacao_2017, shahzad_comprehensive_2025}. Como consequência, permanecem desafios relacionados à viabilidade prática de adoção, à auditabilidade do processo e à consistência preliminar entre correções.
