...
Como parte desta pesquisa, foi implementado um protótipo funcional do sistema proposto, cujo código-fonte foi disponibilizado publicamente em um repositório GitHub, visando transparência e reprodutibilidade \cite{ai_grading_system_repo_2026}.
...
\item Disponibilizar uma interface intuitiva que permita aos professores revisar, ajustar e confirmar as correções realizadas pelo sistema, favorecendo que as avaliações finais permaneçam alinhadas aos objetivos acadêmicos e critérios pedagógicos estabelecidos previamente.
