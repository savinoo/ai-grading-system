...
Desenvolver um sistema automatizado para correção de provas discursivas utilizando modelos avançados de linguagem (LLMs), apoiado pela recuperação dinâmica de contexto, com o objetivo de proporcionar avaliações automáticas, consistentes e alinhadas aos critérios pedagógicos estabelecidos pelos professores.
...
\item Desenvolver um módulo para configuração inicial das provas, em que os professores possam inserir e validar seus próprios critérios avaliativos, contando com sugestões automatizadas oferecidas pelos modelos de linguagem.
...
\item Disponibilizar uma interface intuitiva que permita aos professores revisar, ajustar e validar as correções realizadas pelo sistema, garantindo que as avaliações finais estejam plenamente alinhadas aos objetivos acadêmicos e critérios pedagógicos estabelecidos previamente.

\item Gerar análises estatísticas e de desempenho da avaliação, de modo que fique claro para o professor em quais pontos da matéria os alunos estão mais desfalcados. Possibilitando a adaptação de seu planejamento de aulas.
