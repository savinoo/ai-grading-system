...
\begin{itemize}
    ...
    \item \textbf{Não-determinismo de LLMs:} modelos de linguagem apresentam variabilidade nas saídas. Neste estudo, a estocasticidade foi reduzida por configuração de temperatura igual a $0{,}0$ e por meio da repetição de casos selecionados para avaliar consistência.
