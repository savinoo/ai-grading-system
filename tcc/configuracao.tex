...
%-----------------------------------------------------------
\newcommand{\listarsiglas}{\printnoidxglossary[type=acronym, title=\listadesiglasname, nonumberlist=true]}
\newcommand{\listarsimbolos}{\printnoidxglossary[type=simbolos, title=\listadesimbolosname, nonumberlist=true]}
\newcommand{\listarverbetes}{\printnoidxglossary[type=verbetes]}
...
\usepackage[alf]{abntex2cite}  % Citações padrão ABNT (NBR 10520:2023)
