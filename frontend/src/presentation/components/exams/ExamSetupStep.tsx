...
interface ExamSetupStepProps {
  ...
  classUuid: string;
  setClassUuid: (value: string) => void;
  ...
  // Critérios
  selectedCriteria: CriteriaFormItem[];
  setSelectedCriteria: (criteria: CriteriaFormItem[]) => void;
...
export const ExamSetupStep: React.FC<ExamSetupStepProps> = ({
  title,
  setTitle,
  description,
  setDescription,
  ...
  const handleMaxPointsChange = (index: number, max_points: number) => {
    const newCriteria = [...selectedCriteria];
